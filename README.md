...
pixi add libmamba libmamba-spdlog libmambapy libmambapy-stubs mamba
# for installing globally
pixi global install libmamba libmamba-spdlog libmambapy libmambapy-stubs mamba
```
...
It is possible to list all of the versions of `libmamba` available on your platform:
...
```
pixi search libmamba --channel conda-forge/label/mamba_prerelease
```
