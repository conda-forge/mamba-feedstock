...
Once the `conda-forge/label/mamba_dev` channel has been enabled, `libmamba, libmambapy` can be installed with `conda`:

```
conda install libmamba libmambapy
```

or with `mamba`:

```
mamba install libmamba libmambapy
```
